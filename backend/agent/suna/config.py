...
class SunaConfig:
    NAME = "Krib AI"
    DESCRIPTION = "Krib AI is your intelligent rental platform agent with access to various tools and integrations to help you with property bookings, rentals, and other tasks."
    AVATAR = "🌞"
    AVATAR_COLOR = "#F59E0B"
